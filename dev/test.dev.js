...
"use strict";
eval("\n\nvar _Functions = __webpack_require__(/*! ./Functions */ \"./src/functions/Functions.js\");\n\nvar _Functions2 = _interopRequireDefault(_Functions);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n_Functions2.default.create('SUM', function (start, end) {\n    var context = this.context;\n    var sum = 0;\n    var range = Array.isArray(start) ? start : context.type == 'row' ? this.COL_RANGE(context.col.key, start, end) : this.ROW_RANGE(context.row.key, start, end);\n\n    range.forEach(function (v) {\n        sum += v;\n    });\n\n    return sum;\n});\n\n//# sourceURL=webpack:///./src/functions/SUM.js?");
...
"use strict";
eval("\n\nvar _cubejs = __webpack_require__(/*! ../cubejs */ \"./src/cubejs.js\");\n\nvar _cubejs2 = _interopRequireDefault(_cubejs);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n_cubejs2.default.createOperation('MERGE_ROWS', function (operationDef) {\n    var _this = this;\n\n    var arr = void 0,\n        row = void 0;\n    var v = '';\n    var s = '';\n    var op = _cubejs2.default.getOperation('ADD_ROW');\n\n    operationDef.references.forEach(function (item) {\n        s += v + '\"' + item + '\"';\n        v = ',';\n    });\n\n    // cria a linha nova\n    op.call(this, {\n        key: operationDef.key,\n        position: operationDef.position || 'last',\n        reference: operationDef.reference,\n        expression: 'SUM(VALUES(' + s + '))',\n        display: operationDef.display\n    });\n\n    // remove as linhas envolvidas na concatenação\n    operationDef.references.forEach(function (item) {\n        row = _this.findRow(item);\n        if (row) {\n            arr = row.parent ? row.parent : _this.getMaps().rows;\n            arr.splice(row._index, 1);\n\n            // atualiza _index\n            arr.forEach(function (item, index) {\n                item._index = index;\n            });\n        }\n    });\n}); // @ts-check\n\n//# sourceURL=webpack:///./src/operations/MERGE_ROWS.js?");
...
"use strict";
eval("\n\nvar _cubejs = __webpack_require__(/*! ../cubejs */ \"./src/cubejs.js\");\n\nvar _cubejs2 = _interopRequireDefault(_cubejs);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n_cubejs2.default.createOperation('REMOVE_ROW', function (operationDef) {\n    var arr = void 0;\n    var row = this.findRow(operationDef.reference);\n\n    if (row) {\n        arr = row.parent ? row.parent : this.getMaps().rows;\n        arr.splice(row._index, 1);\n\n        // atualiza _index\n        arr.forEach(function (item, index) {\n            item._index = index;\n        });\n    }\n}); // @ts-check\n\n//# sourceURL=webpack:///./src/operations/REMOVE_ROW.js?");
